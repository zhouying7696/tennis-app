  ...
  <div class="edit-activity-container">
    <el-card>
      ...
      <el-form :model="activityForm" label-width="120px" style="max-width: 600px;">
        ...
        <el-form-item>
          <el-button type="primary" @click="submitForm" :loading="loading">更新活动</el-button>
...
const getActivityDetail = async () => {
  ...
  try {
    ...
    const startTime = new Date(`2000-01-01 ${activity.start_time}`)
    const endTime = new Date(`2000-01-01 ${activity.end_time}`)
...
const submitForm = async () => {
  ...
  try {
    ...
    ElMessage.error(error.response?.data?.message || '更新活动失败')
  } finally {
    loading.value = false
  }
}
